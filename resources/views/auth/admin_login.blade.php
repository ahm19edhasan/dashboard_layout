...
<body id="kt_body" class="bg-dark">
    ...
    <div class="d-flex flex-column flex-root">
        ...
        <div class="d-flex flex-column flex-column-fluid bgi-position-y-bottom position-x-center bgi-no-repeat bgi-size-contain bgi-attachment-fixed"
            style="background-size: 100% 50%; background-image: url({{ asset('dashboard_assets/media/misc/outdoor.png') }})">
            <!--begin::Content-->
                ...
                <div class="w-lg-500px bg-white rounded shadow-sm p-10 p-lg-15 mx-auto">
                    ...
                    <form class="form w-100" action="{{ route('admin.store.login') }}" method="POST">
                        ...
                        <div class="text-center mb-10">
                            <!--begin::Title-->
                            <h1 class="text-dark mb-3">Sign In to Optical Dashboard </h1>
                            <!--end::Title-->
                        </div>
                        <!--begin::Heading-->
                        <!--begin::Input group-->
