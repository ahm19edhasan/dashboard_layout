            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                ...
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                    <div class="menu-item">
                        <a class="menu-link" href="{{ route('box_header.index') }}" title="Main Page - Box Header"
                            ...
                            <span class="menu-title ml-5" style="margin-left: 17px;">Statistics</span>
                        </a>
                    </div>
                    ...
                    <div class="menu-item">
                        <a class="menu-link" href="{{ route('why_choose_us.edit', ['id' => 1]) }}"
                            title="Main Page - Products" data-bs-toggle="tooltip" data-bs-trigger="hover"
                    ...
                    <div class="menu-item">
                        <a class="menu-link" href="{{ route('who_are_we.edit', ['id' => 1]) }}"
                            title="Main Page - Products" data-bs-toggle="tooltip" data-bs-trigger="hover"
                            data-bs-dismiss="click" data-bs-placement="right">
                            <i class="fa-brands fa-product-hunt fs-2"></i>
                    ...
                    <div class="menu-item">
                        <a class="menu-link" href="{{ route('testimonial.index') }}" title="Main Page - Products"
                            data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click"
                            data-bs-placement="right">
                            <i class="fa-brands fa-product-hunt fs-2"></i>
                ...
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                    ...
                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                        ...
                        <div class="menu-item">
                            <a class="menu-link" href="{{ route('services_page.edit', ['id' => 1]) }}"
                                title="Our Partners Table">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                    ...
                    <div class="menu-item">
                        <a class="menu-link" href="{{ route('products_page.edit', ['id' => 1]) }}"
                            title="Main Page - Products" data-bs-toggle="tooltip" data-bs-trigger="hover"
                            data-bs-dismiss="click" data-bs-placement="right">
                            <i class="fa-brands fa-product-hunt fs-2"></i>
                    ...
                    <div class="menu-item">
                        <a class="menu-link" href="{{ route('about.edit', ['id' => 1]) }}" title="About Us"
                            data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click"
                            data-bs-placement="right">
                            <i class="fa-brands fa-product-hunt fs-2"></i>
                    ...
                    <div class="menu-item">
                        <a class="menu-link" href="{{ route('faqs.index') }}" title="Faqs"
                            data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click"
                            data-bs-placement="right">
                            <i class="fa-brands fa-product-hunt fs-2"></i>
                    ...
                    <div class="menu-item">
                        <a class="menu-link" href="{{ route('term.index') }}" title="Term"
                            data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click"
                            data-bs-placement="right">
                            <i class="fa-brands fa-product-hunt fs-2"></i>
                    ...
                    <div class="menu-item">
                        <a class="menu-link" href="{{ route('privacy.index') }}" title="Privacy"
                            data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click"
                            data-bs-placement="right">
                            <i class="fa-brands fa-product-hunt fs-2"></i>
                    ...
                    <div class="menu-item">
                        <a class="menu-link" href="{{ route('gallery.index') }}" title="Privacy"
                            data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click"
                            data-bs-placement="right">
                            <i class="fa-brands fa-product-hunt fs-2"></i>
                    ...
                    <div class="menu-item">
                        <a class="menu-link" href="{{ route('setting.edit', ['id' => 1]) }}" title="Privacy"
                            data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click"
                            data-bs-placement="right">
                            <i class="fa-brands fa-product-hunt fs-2"></i>
